 ...
 * @author heito
 */
public class JIFControleprojecaoreceita extends javax.swing.JInternalFrame {

    ContasReceberData DAO;
    ContasReceberModel obj;
    ArrayList<ContasReceberModel> lista;
    public JIFControleprojecaoreceita() {
    ...
    private void initComponents() {
        ...
        setIconifiable(true);
        setMaximizable(true);
        setTitle("Controle de Projeção de Receitas");

        jLabel1.setFont(new java.awt.Font("Tahoma", 0, 18)); // NOI18N
        jLabel1.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        jLabel1.setText("Pesquise a Data da PROJEÇÃO RECEITA");
    ...
    private boolean atualizarObjeto() throws Exception{
        obj.setIdreceber(Integer.parseInt(jtPesquisa.getText()));  
    return true;    
    }
