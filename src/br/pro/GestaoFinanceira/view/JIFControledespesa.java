 ...
 * @author heito
 */
public class JIFControledespesa extends javax.swing.JInternalFrame {

    DespesasData DAO;
    DespesasModel obj;
    ArrayList<DespesasModel> lista;
    public JIFControledespesa() {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Pesquise a data da DESPESA");
    ...
    try {
        ...
        for(DespesasModel ob: lista){
            mp.addRow(new String[]{""+ob.getIddespesa(),""+ob.getValordespesa(),ob.getDatadespesa(),ob.getDetalhamentodespesa(),""+ob.isVerifdespesa()});
        }
    ...
    private boolean atualizarObjeto() throws Exception{
        obj.setIddespesa(Integer.parseInt(jtPesquisa.getText()));  
    return true;    
    }
