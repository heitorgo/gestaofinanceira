 ...
 * @author heito
 */
public class JIFControleprojecaosaida extends javax.swing.JInternalFrame {

    ContasPagarData DAO;
    ContasPagarModel obj;
    ArrayList<ContasPagarModel> lista;
    public JIFControleprojecaosaida() {
    ...
    private void initComponents() {
        ...
        setIconifiable(true);
        setMaximizable(true);
        setTitle("Controle de Projeção Custos/Despesas");

        jLabel1.setFont(new java.awt.Font("Tahoma", 0, 18)); // NOI18N
        jLabel1.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        jLabel1.setText("Pesquise a data da PROJEÇÃO CUSTO/DESPESA  ");
    ...
    try {
        lista = DAO.pesquisarprojecao(jtPesquisa.getText());
    ...
    private boolean atualizarObjeto() throws Exception{
        obj.setIdpagar(Integer.parseInt(jtPesquisa.getText()));  
    return true;    
    }
