 ...
 * @author heito
 */
public class JIFControlevenda extends javax.swing.JInternalFrame {

    VendasData DAO;
    VendasModel obj;
    ArrayList<VendasModel> lista;
    public JIFControlevenda() {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Informe a Data do custo");
    ...
    try {
        ...
        for(VendasModel ob: lista){
            mp.addRow(new String[]{""+ob.getIdvenda(),""+ob.getValorvenda(),""+ob.getDatavenda(),""+ob.isVerifvenda()});
        }
    ...
    private boolean atualizarObjeto() throws Exception{
        obj.setIdvenda(Integer.parseInt(jtPesquisa.getText()));  
    return true;    
    }
