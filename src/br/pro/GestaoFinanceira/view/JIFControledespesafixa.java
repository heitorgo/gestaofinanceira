 ...
 * @author heito
 */
public class JIFControledespesafixa extends javax.swing.JInternalFrame {

    DespesasFixasData DAO;
    DespesasFixasModel obj;
    ArrayList<DespesasFixasModel> lista;
    public JIFControledespesafixa() {
    ...
    private void initComponents() {
        ...
        setIconifiable(true);
        setMaximizable(true);
        setTitle("Controle de Despesas Fixas");

        jLabel1.setFont(new java.awt.Font("Tahoma", 0, 18)); // NOI18N
        jLabel1.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        jLabel1.setText("Pesquise a Data da DESPESA FIXA");
    ...
    try {
        ...
        for(DespesasFixasModel ob: lista){
            mp.addRow(new String[]{""+ob.getIddespesafixa(),""+ob.getValordespesafixa(),ob.getFrequenciadespesa(),ob.getDetalhamentodespesafixa(),""+ob.isVerifdespesafixa()});
        }
    ...
    private boolean atualizarObjeto() throws Exception{
        obj.setIddespesafixa(Integer.parseInt(jtPesquisa.getText()));  
    return true;    
    }
