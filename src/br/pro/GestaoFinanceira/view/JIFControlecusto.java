 ...
 * @author heito
 */
public class JIFControlecusto extends javax.swing.JInternalFrame {

    CustosData DAO;
    CustosModel obj;
    ArrayList<CustosModel> lista;
    public JIFControlecusto() {
    ...
    private void initComponents() {
        ...
        setIconifiable(true);
        setMaximizable(true);
        setTitle("Controle de Custos");

        jLabel1.setFont(new java.awt.Font("Tahoma", 0, 18)); // NOI18N
        jLabel1.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        jLabel1.setText("Pesquise a Data do CUSTO");
    ...
    private boolean atualizarObjeto() throws Exception{
        obj.setIdcusto(Integer.parseInt(jtPesquisa.getText()));  
        return true;    
    }
