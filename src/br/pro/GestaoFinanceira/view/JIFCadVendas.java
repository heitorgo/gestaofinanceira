...
import br.pro.GestaoFinanceira.data.VendasData;
 ...
 * @author heito
 */
public class JIFCadVendas extends javax.swing.JInternalFrame {
    //objeto model
    ...
    private void initComponents() {
        ...
        jlIdvenda1 = new javax.swing.JLabel();
        ...
        jlDetalhamentovenda = new javax.swing.JLabel();
        jtDetalhamentovenda = new javax.swing.JTextField();
        jLabel1 = new javax.swing.JLabel();
        jtDatavenda = new javax.swing.JFormattedTextField();
        ...
        jlDatavenda1 = new javax.swing.JLabel();
        jtDetalhamentovenda1 = new javax.swing.JTextField();
        jlDetalhamentovenda1 = new javax.swing.JLabel();
        ...
        jtDatavenda1 = new javax.swing.JFormattedTextField();
        ...
        setIconifiable(true);
        setMaximizable(true);
        setTitle("Cadastro/Edição de Vendas");
        setEnabled(false);

        jPanel1.setLayout(null);

        jlIdvenda.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        jlIdvenda.setText("*ID:");
        jPanel1.add(jlIdvenda);
        jlIdvenda.setBounds(10, 52, 100, 30);

        jlIdvenda1.setBorder(new javax.swing.border.SoftBevelBorder(javax.swing.border.BevelBorder.RAISED));
        jPanel1.add(jlIdvenda1);
        jlIdvenda1.setBounds(116, 52, 237, 30);
        ...
        jlDatavenda.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        jlDatavenda.setText("*Data:");
        jPanel1.add(jlDatavenda);
        jlDatavenda.setBounds(10, 100, 100, 30);

        jlValorvenda.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        jlValorvenda.setText("*Valor:");
        jPanel1.add(jlValorvenda);
        jlValorvenda.setBounds(10, 148, 100, 30);

        jtValorvenda.setEnabled(false);
        jPanel1.add(jtValorvenda);
        jtValorvenda.setBounds(116, 148, 237, 30);

        jlDetalhamentovenda.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        jlDetalhamentovenda.setText("*Detalhamento:");
        jPanel1.add(jlDetalhamentovenda);
        jlDetalhamentovenda.setBounds(12, 196, 100, 30);

        jtDetalhamentovenda.setEnabled(false);
        jPanel1.add(jtDetalhamentovenda);
        jtDetalhamentovenda.setBounds(116, 196, 237, 30);
        ...
        try {
            jtDatavenda.setFormatterFactory(new javax.swing.text.DefaultFormatterFactory(new javax.swing.text.MaskFormatter("##-##-####")));
        } catch (java.text.ParseException ex) {
            ex.printStackTrace();
        }
        jtDatavenda.setEnabled(false);
        jPanel1.add(jtDatavenda);
        jtDatavenda.setBounds(116, 100, 237, 30);
        ...
        jlDatavenda1.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        jlDatavenda1.setText("*Data:");

        jtDetalhamentovenda1.setEnabled(false);

        jlDetalhamentovenda1.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        jlDetalhamentovenda1.setText("*Detalhamento:");

        jlValorvenda1.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        jlValorvenda1.setText("*Valor:");

        jtValorvenda1.setEnabled(false);
        jtValorvenda1.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                jtValorvenda1ActionPerformed(evt);
            }
        });
        ...
        jLabel2.setText("Digite a data para realizar Alteração/Exclusão de VENDAS");
        ...
        try {
            jtDatavenda1.setFormatterFactory(new javax.swing.text.DefaultFormatterFactory(new javax.swing.text.MaskFormatter("##-##-####")));
        } catch (java.text.ParseException ex) {
            ex.printStackTrace();
        }
        jtDatavenda1.setEnabled(false);
                ...
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(jPanel2Layout.createSequentialGroup()
                        .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                            .addComponent(jlValorvenda1, javax.swing.GroupLayout.PREFERRED_SIZE, 100, javax.swing.GroupLayout.PREFERRED_SIZE)
                            .addComponent(jlDatavenda1, javax.swing.GroupLayout.PREFERRED_SIZE, 100, javax.swing.GroupLayout.PREFERRED_SIZE))
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                        .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addGroup(jPanel2Layout.createSequentialGroup()
                                .addComponent(jtValorvenda1, javax.swing.GroupLayout.PREFERRED_SIZE, 237, javax.swing.GroupLayout.PREFERRED_SIZE)
                                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                                .addComponent(jlDetalhamentovenda1, javax.swing.GroupLayout.PREFERRED_SIZE, 100, javax.swing.GroupLayout.PREFERRED_SIZE)
                                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                                .addComponent(jtDetalhamentovenda1, javax.swing.GroupLayout.PREFERRED_SIZE, 237, javax.swing.GroupLayout.PREFERRED_SIZE)
                                .addContainerGap(javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))
                            .addGroup(jPanel2Layout.createSequentialGroup()
                                .addComponent(jtDatavenda1, javax.swing.GroupLayout.PREFERRED_SIZE, 237, javax.swing.GroupLayout.PREFERRED_SIZE)
                                .addContainerGap(javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))))
                    .addGroup(jPanel2Layout.createSequentialGroup()
                        .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
        ...
        jPanel2Layout.setVerticalGroup(
            ...
            .addGroup(jPanel2Layout.createSequentialGroup()
                ...
                .addGap(18, 18, 18)
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(jlDetalhamentovenda1, javax.swing.GroupLayout.PREFERRED_SIZE, 30, javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addComponent(jtDetalhamentovenda1, javax.swing.GroupLayout.PREFERRED_SIZE, 30, javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addComponent(jtValorvenda1, javax.swing.GroupLayout.PREFERRED_SIZE, 30, javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addComponent(jlValorvenda1, javax.swing.GroupLayout.PREFERRED_SIZE, 30, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addGap(18, 18, 18)
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(jlDatavenda1, javax.swing.GroupLayout.PREFERRED_SIZE, 30, javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addComponent(jtDatavenda1, javax.swing.GroupLayout.PREFERRED_SIZE, 30, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addGap(30, 30, 30))
        );
            ...
            if(validarCampos()){
                if(preencherObjeto()){
                    if(DAO.incluir(obj)){
                        ...
                        JOptionPane.showMessageDialog(this, "Erro ao salvar: ", "Salvar-Venda", JOptionPane.ERROR_MESSAGE);
                    }
                }
            }    
        }catch (Exception e){
            JOptionPane.showMessageDialog(this, "Erro ao salvar: " + e.getMessage(), "Salvar-Venda", JOptionPane.ERROR_MESSAGE);   
        }
    ...
    private void jbExcluirActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jbExcluirActionPerformed
        int resposta = JOptionPane.showConfirmDialog(this ,"Você tem certeza que deseja Excluir a Venda ("+jlIdvenda1.getText()+")", "Exclusão",JOptionPane.YES_NO_OPTION);
        if (resposta == 0) {
            try {
                if(DAO.excluir(Integer.parseInt(jlIdvenda1.getText()))){
    ...
    private void jtbDadosMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jtbDadosMouseClicked
         try {
            ...
            if(linha>-1){
                jlIdvenda1.setText(jtbDados.getValueAt(linha, 0).toString());
                jtValorvenda1.setText(jtbDados.getValueAt(linha, 1).toString());
                jtDatavenda1.setText(jtbDados.getValueAt(linha, 2).toString());
                jtDetalhamentovenda1.setText(jtbDados.getValueAt(linha,3).toString());
        ...
        if(validarCampos1()){
            if(atualizarObjeto()){    
                if(DAO.editar(obj)){
                    ...
                    JOptionPane.showMessageDialog(this, "Erro ao Atualizar: ", "Atualizar-Venda", JOptionPane.ERROR_MESSAGE);
                }
            }
        }
    }catch (Exception e){
        JOptionPane.showMessageDialog(this, "Erro ao atualizar: " + e.getMessage(), "Atualizar-Venda", JOptionPane.ERROR_MESSAGE);       
    }
    ...
    private void jbPesquisarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jbPesquisarActionPerformed
        ...
        mp.setNumRows(0);
        for(VendasModel ob: lista){
            mp.addRow(new String[]{""+ob.getIdvenda(),""+ob.getValorvenda(),""+ob.getDatavenda(),ob.getDetalhamentovenda()});
        }
        jbCancelar1.setEnabled(true);
        jbPesquisar.setEnabled(false);
    } catch (Exception e) {
    ...
    private void jtValorvenda1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jtValorvenda1ActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_jtValorvenda1ActionPerformed
    ...
    private javax.swing.JLabel jlDatavenda1;
    private javax.swing.JLabel jlDetalhamentovenda;
    private javax.swing.JLabel jlDetalhamentovenda1;
    private javax.swing.JLabel jlEmpresa;
    private javax.swing.JLabel jlIdvenda;
    private javax.swing.JLabel jlIdvenda1;
    private javax.swing.JLabel jlPesquisa;
    private javax.swing.JLabel jlValorvenda;
    private javax.swing.JLabel jlValorvenda1;
    private javax.swing.JFormattedTextField jtDatavenda;
    private javax.swing.JFormattedTextField jtDatavenda1;
    private javax.swing.JTextField jtDetalhamentovenda;
    private javax.swing.JTextField jtDetalhamentovenda1;
    ...
    private boolean validarCampos1(){
        if(jtDatavenda1.getText().trim().length()<7 ){
            JOptionPane.showMessageDialog(null, "Caractere data Insuficiente(<7)", "ERRO", JOptionPane.ERROR_MESSAGE);
            return false;
        }
        if(jtValorvenda1.getText().trim().length()<1 ){
            JOptionPane.showMessageDialog(null, "Caractere valor Insuficiente(<1)", "ERRO", JOptionPane.ERROR_MESSAGE);
            return false;
        }
        if(jtDetalhamentovenda1.getText().equals("")){
            JOptionPane.showMessageDialog(null, "Detalhamento Vazio", "ERRO", JOptionPane.ERROR_MESSAGE);
            return false;
        }
        return true;
    ...
    private boolean preencherObjeto() throws Exception{
        obj.setIdvenda(Integer.parseInt(jlIdvenda1.getText()));
        obj.setDatavenda(jtDatavenda.getText());
        obj.setValorvenda(Float.parseFloat(jtValorvenda.getText()));
        obj.setDetalhamentovenda(jtDetalhamentovenda.getText());
    ...
    private boolean atualizarObjeto() throws Exception{
        obj.setIdvenda(Integer.parseInt(jlIdvenda1.getText()));
        obj.setDatavenda(jtDatavenda1.getText());
        obj.setValorvenda(Float.parseFloat(jtValorvenda1.getText()));
        obj.setDetalhamentovenda(jtDetalhamentovenda1.getText());
        obj.setEmpresa(listaEmpresa.get(jcbEmpresa.getSelectedIndex()));
        return true;    
    }
    private void formatarCampos() throws Exception{
        MaskFormatter maskdata = new MaskFormatter("##-##-####");
        maskdata.install(jtDatavenda);
        maskdata.install(jtDatavenda1);
